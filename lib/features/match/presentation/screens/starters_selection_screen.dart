...
class _StartersSelectionScreenState
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: Text(
          isEditing
              ? "Editar Jugador"
              : "Nuevo Jugador - ${isTeamA ? 'Local' : 'Visita'}",
        ...
        actions: [
          ...
          FilledButton(
            ...
            onPressed: () async {
              ...
              // =================================================================
              final duplicates = currentRoster.where(
                (p) => p.defaultNumber == number && p.id != playerToEdit?.id,
              );
              ...
              if (duplicates.isNotEmpty) {
                ...
                await (dbBase.update(
                      dbBase.players,
                    )..where((p) => p.id.equals(duplicatePlayer.id.toString())))
                    .write(
                      db.PlayersCompanion(
              ...
              if (isEditing) {
                ...
                await (dbBase.update(
                  dbBase.players,
                )..where((p) => p.id.equals(playerToEdit.id.toString()))).write(
                  db.PlayersCompanion(
      ...
      child: Row(
        ...
        children: [
          ...
          IconButton(
            ...
            onPressed: () => _showPlayerFormDialog(isTeamA),
          ),
        ],
      ),
    );
  ...
  Widget _buildSelectionList(
    ...
    return GridView.builder(
      ...
      gridDelegate: const SliverGridDelegateWithMaxCrossAxisExtent(
        maxCrossAxisExtent:
            160, // REDUCIDO DE 220 A 160 (Tarjetas más pequeñas)
                  ...
                  Positioned(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        color: isSelected
                            ? Colors.white
                            : Colors.white70, // Siempre visible
                        letterSpacing: -3,
                        height: 0.9,
                        shadows: const [
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              _buildTeamStatusColumn(
                widget.teamA.shortName,
                _startersA.length,
                _captainAId != null,
              ),
              _buildTeamStatusColumn(
                widget.teamB.shortName,
                _startersB.length,
                _captainBId != null,
              ),
            ],
    ...
    return Column(
      children: [
        ...
        Text(
          "$count/5",
          style: TextStyle(
            color: count == 5 ? Colors.greenAccent : Colors.orangeAccent,
            fontSize: 14,
            fontWeight: FontWeight.bold,
          ),
        ),
        Text(
          cap ? "Capitán OK" : "Falta Capitán",
          style: TextStyle(
            color: cap ? Colors.greenAccent : Colors.redAccent,
            fontSize: 10,
          ),
        ),
      ],
  ...
  Future<void> _startGame() async {
    ...
    try {
      ...
      final existingMatch = await (dbBase.select(
        dbBase.matches,
        ...
        await dbBase
            ...
            .insert(
              db.MatchesCompanion.insert(
                ...
                status: const drift.Value(MatchStatus.inProgress),

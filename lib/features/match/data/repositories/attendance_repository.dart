...
class AttendanceRepository {
  ...
  Future<List<RosterWithName>> getRoster(String matchId) =>
      _dao.getRosterWithNames(matchId);
  ...
  Future<Result<String?>> saveAttendance(
    String matchId,
    ...
    final list = byPlayerId.entries
        .map(
          (e) => {
            "player_id": int.tryParse(e.key) ?? 0,
            "attended": e.value ? 1 : 0,
          },
        )
        .toList();
